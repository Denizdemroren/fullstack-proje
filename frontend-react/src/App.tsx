...
import { LogIn, UserPlus, LogOut, Package, Trash2, Edit2, PlusCircle, AlertTriangle, CheckCircle, XCircle } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  // Dashboard Bileşeni (Formun Dinamik Hale Getirilmesi)
  const Dashboard: React.FC = () => (
    <div className="p-4 sm:p-8 min-h-screen bg-gray-100 font-sans">
        ...
        <header className="flex justify-between items-center mb-10 bg-white p-6 rounded-xl shadow-xl sticky top-0 z-10 border-b-4 border-indigo-500">
            ...
            <div className="flex items-center space-x-3">
                <span className="text-gray-600 text-sm hidden sm:inline">Hoş Geldiniz, <strong className="font-extrabold text-indigo-600">{username}</strong></span>
                <button
